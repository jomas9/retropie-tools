...
{
	snapbg = fe.add_image(
		"static.mp4", flx*0.042, fly*0.268, flw*0.312, flh*0.463);
...
surface.set_pos(flx*0.042, fly*0.268, flw*0.312, flh*0.463);
surface.skew_y = 0;
surface.skew_x = 0;
surface.pinch_y = 0;
surface.pinch_x = 0;
...
{
local boxart = fe.add_artwork("boxart", flx*0.01, fly*0.68 flw*0.11, flh*0.26 );
}
