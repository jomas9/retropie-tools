...
{
local point = fe.add_image("pointers/pointer.png", flx*0.90, fly*0.34, flw*0.1, flh*0.35);
...
{
local boxart = fe.add_artwork("boxart", flx*0.50, fly*0.64 flw*0.12, flh*0.29 );
}
