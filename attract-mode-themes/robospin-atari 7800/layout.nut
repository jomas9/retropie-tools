...
{
	snapbg = fe.add_image(
		"static.mp4", flx*0.033, fly*0.205, flw*0.332, flh*0.483);
...
surface.set_pos(flx*0.033, fly*0.205, flw*0.332, flh*0.483);
surface.skew_y = 0;
surface.skew_x = 0;
surface.pinch_y = 0;
surface.pinch_x = 0;
...
{
local boxart = fe.add_artwork("boxart", flx*0.51, fly*0.62 flw*0.14, flh*0.30 );
}
