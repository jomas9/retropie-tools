...
{
local point = fe.add_image("pointers/pointer.png", flx*0.89, fly*0.34, flw*0.2, flh*0.35);
...
{
local boxart = fe.add_artwork("boxart", flx*0.40, fly*0.20 flw*0.12, flh*0.28 );
}
