...
{
local point = fe.add_image("pointers/pointer.png", flx*0.86, fly*0.34, flw*0.2, flh*0.35);
...
{
local boxart = fe.add_artwork("boxart", flx*0.47, fly*0.60 flw*0.15, flh*0.35 );
}
