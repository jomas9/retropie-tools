...
class UserConfig {
   ...
   </ label="Select cab skin", help="Select a cab skin image", options="megadrive,genesis", order=2 /> enable_cab="megadrive";
...
//cabinet image
if ( my_config["enable_cab"] == "megadrive" )
{
 local cab = fe.add_image( "robo.png", 0, 0, flw, flh );
}

if ( my_config["enable_cab"] == "genesis" )
{
...
{
local point = fe.add_image("pointers/pointer.png", flx*0.91, fly*0.34, flw*0.2, flh*0.35);
...
{
local boxart = fe.add_artwork("boxart", flx*0.50, fly*0.62 flw*0.13, flh*0.31 );
}
