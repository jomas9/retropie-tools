...
{
	snapbg = fe.add_image(
		"static.mp4", flx*0.14, fly*0.25, flw*0.29, flh*0.36);
...
surface.set_pos(flx*0.12, fly*0.281, flw*0.26, flh*0.33);
surface.skew_y = 0;
surface.skew_x = 0;
surface.pinch_y = 0;
surface.pinch_x = 0;
surface.rotation = 7.5;
...
{
local boxart = fe.add_artwork("boxart", flx*0.47, fly*0.58 flw*0.18, flh*0.38 );
}
