...
{
	snapbg = fe.add_image(
		"static.mp4", flx*0.13, fly*0.15, flw*0.17, flh*0.285);
    snapbg.trigger = Transition.EndNavigation;
	snapbg.skew_y = 0;
    snapbg.skew_x = 0;
    snapbg.pinch_y = -1;
    snapbg.pinch_x = 3;
    snapbg.rotation = 16.7;
...
surface.set_pos(flx*0.13, fly*0.15, flw*0.171, flh*0.285);
surface.skew_y = 2;
surface.skew_x = 0;
surface.pinch_y = -1;
surface.pinch_x = 3;
surface.rotation = 16.7;
...
{
local point = fe.add_image("pointers/pointer.png", flx*0.92, fly*0.34, flw*0.2, flh*0.35);
...
{
local boxart = fe.add_artwork("boxart", flx*0.45, fly*0.60 flw*0.18, flh*0.32 );
}
