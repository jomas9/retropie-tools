...
{
	snapbg = fe.add_image(
		"static.mp4", flx*0.082, fly*0.22, flw*0.24, flh*0.39);
...
surface.set_pos(flx*0.082, fly*0.22, flw*0.24, flh*0.39);
surface.skew_y = 58;
surface.skew_x = 0;
surface.pinch_y = -28;
surface.pinch_x = -10;
...
{
local boxart = fe.add_artwork("boxart", flx*0.47, fly*0.64 flw*0.20, flh*0.29 );
}
