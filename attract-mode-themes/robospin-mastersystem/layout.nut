...
{
	snapbg = fe.add_image(
		"static.mp4", flx*0.047, fly*0.24, flw*0.303, flh*0.43);
...
surface.set_pos(flx*0.047, fly*0.24, flw*0.303, flh*0.43);
surface.skew_y = 0;
surface.skew_x = 0;
surface.pinch_y = 0;
surface.pinch_x = 0;
...
{
local boxart = fe.add_artwork("boxart", flx*0.02, fly*0.65 flw*0.13, flh*0.28 );
}
