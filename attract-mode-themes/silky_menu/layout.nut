...
local flyerW = lbw
local flyer = fe.add_image("default.png", flw + flx - crw - flyerW, bth, flyerW, flyerH )
	...
	if( update_artwork == true ) {
		...
		switch ( update_counter ) {
			...
			case 2:
				...
				break
			case 3:
				if ( glist_delay != 0 ) flyer.file_name = fe.get_art( "flyer" )
				break
			case 4:
