...
{
	snapbg = fe.add_image(
		"static.mp4", flx*0.031, fly*0.25, flw*0.332, flh*0.503);
...
surface.set_pos(flx*0.031, fly*0.25, flw*0.332, flh*0.503);
surface.skew_y = 0;
surface.skew_x = 0;
surface.pinch_y = 0;
surface.pinch_x = 0;
...
{
local boxart = fe.add_artwork("boxart", flx*0.56, fly*0.64 flw*0.12, flh*0.3 );
}
