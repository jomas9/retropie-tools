...
class UserConfig {
   </ label="Select bg image or panscan", help="Select bg image or panscan art(flyer)", options="Purple,Red,Panscan", order=1 /> enable_image="Purple";   
   </ label="Select cab skin", help="Select a cab skin image", options="Purple,Red", order=2 /> enable_cab="Purple";
   ...
   </ label="Enable random Text Colors", help=" Select random text colors.", options="yes,no", order=9 /> enable_colors="no";
   ...
   </ label="Select pointer", help="Select animated pointer", options="Purple,Red,none", order=14 /> enable_pointer="Purple"; 
   ...
   </ label="Enable box art", help="Enable box art", options="Yes,No", order=19 /> enable_gboxart="Yes";
}  
...
if ( my_config["enable_image"] == "Purple") 
{
...
{
	snapbg = fe.add_image(
		"static.mp4", flx*0.102, fly*0.28, flw*0.322, flh*0.460);
...
surface.set_pos(flx*0.102, fly*0.28, flw*0.322, flh*0.460);
surface.skew_y = 0;
surface.skew_x = 0;
surface.pinch_y = 0;
surface.pinch_x = 0;
...
//cabinet image
if ( my_config["enable_cab"] == "Purple" )
{
...
if ( my_config["enable_pointer"] == "Purple") 
{
...
{
local boxart = fe.add_artwork("boxart", flx*0.14, fly*0.7 flw*0.12, flh*0.24 );
}
