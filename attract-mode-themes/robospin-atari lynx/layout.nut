...
{
	snapbg = fe.add_image(
		"static.mp4", flx*0.17, fly*0.333, flw*0.205 flh*0.235);
...
surface.set_pos(flx*0.17, fly*0.333, flw*0.205 flh*0.235);
surface.skew_y = 0;
surface.skew_x = 0;
surface.pinch_y = 0;
surface.pinch_x = 0;
...
{
local boxart = fe.add_artwork("boxart", flx*0.55, fly*0.65, flw*0.125, flh*0.27 );
}
