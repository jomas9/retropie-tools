...
{
	snapbg = fe.add_image(
		"static.mp4", flx*0.17, fly*0.206, flw*0.27, flh*0.58);
...
surface.set_pos(flx*0.24, fly*0.365, flw*0.159, flh*0.435);
surface.skew_y = -65;
surface.skew_x = -20;
surface.pinch_y = 5;
surface.pinch_x = -30;
surface.rotation = 25.9;
...
//now position and pinch the surface
surface.set_pos(flx*0.25, fly*0.235, flw*0.178, flh*0.233);
surface.skew_y = 0;
surface.skew_x = -30;
surface.pinch_y = 0;
surface.pinch_x = -30;
...
{
local point = fe.add_image("pointers/pointer.png", flx*0.90, fly*0.34, flw*0.10, flh*0.35);
...
{
local boxart = fe.add_artwork("boxart", flx*0.47, fly*0.64 flw*0.175, flh*0.29 );
}
