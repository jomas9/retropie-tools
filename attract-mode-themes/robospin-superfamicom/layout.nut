...
class UserConfig {
   </ label="Select bg image or panscan", help="Select bg image or panscan art(flyer)", options="SNES,Black,Panscan", order=1 /> enable_image="blue";   
   ...
   </ label="Select pointer", help="Select animated pointer", options="SNES,Hand,none", order=14 /> enable_pointer="rocket"; 
...
if ( my_config["enable_image"] == "SNES") 
{
...
if ( my_config["enable_pointer"] == "SNES") 
{
...
{
local boxart = fe.add_artwork("boxart", flx*0.45, fly*0.6 flw*0.08, flh*0.4 );
