...
class UserConfig {
   ...
   </ label="Select cab skin", help="Select a cab skin image", options="segacd,megacd", order=2 /> enable_cab="segacd";
...
//cabinet image
if ( my_config["enable_cab"] == "segacd" )
{
 local cab = fe.add_image( "robo.png", 0, 0, flw, flh );
}

if ( my_config["enable_cab"] == "megacd" )
{
...
{
local boxart = fe.add_artwork("boxart", flx*0.47, fly*0.62 flw*0.17, flh*0.34 );
}
