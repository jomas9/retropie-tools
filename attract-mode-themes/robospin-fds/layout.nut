...
{
	snapbg = fe.add_image(
		"static.mp4", flx*0.033, fly*0.25, flw*0.332, flh*0.503);
...
surface.set_pos(flx*0.033, fly*0.25, flw*0.332, flh*0.503);
surface.skew_y = 0;
surface.skew_x = 0;
surface.pinch_y = 0;
surface.pinch_x = 0;
...
{
local point = fe.add_image("pointers/pointer.png", flx*0.91, fly*0.34, flw*0.1, flh*0.35);
...
{
local boxart = fe.add_artwork("boxart", flx*0.56, fly*0.70 flw*0.12, flh*0.20 );
}
