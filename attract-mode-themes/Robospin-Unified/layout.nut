...
{
local basemarquee = fe.add_image( "clogos/[DisplayName]", flx*0.080, fly*0.075, flw*0.2625, flh*0.143 );
 basemarquee.trigger = Transition.EndNavigation;
 basemarquee.skew_x = 11;
 basemarquee.pinch_x = -2;
 basemarquee.pinch_y = 3;
 basemarquee.rotation = -1.5;
...
//Year text info
local texty = fe.add_text("[Year]", flx*0.18, fly*0.94, flw*0.13, flh*0.055 );
...
//Display filter info
local filter = fe.add_text( "[ListFilterName]: [ListEntry]-[ListSize]", flx*0.06, fly*0.675, flw*0.25, flh*0.04 );
